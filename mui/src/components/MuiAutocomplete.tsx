...
const MuiAutocomplete = () => {
  ...
  return (
    <Stack spacing={2} width='300px'>
        {/* Example of tracking it as a string */}
      <Autocomplete options={array} renderInput={(params) => <TextField label='Skills' {...params}/>}
       value={value} onChange={(event: any, newValue: string | null) => {setValue(newValue)}} 
      />

      {/* Example How to track the values in an object */}
      <Autocomplete options={skillOption} renderInput={(params) => <TextField label='Skills' {...params}/>}
